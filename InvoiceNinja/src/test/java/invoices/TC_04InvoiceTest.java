...
public class TC_04InvoiceTest {
	...
	invoice.getItemTextField().sendKeys("Mobile");
	invoice.getItemDescription().sendKeys("Redmi note 9 Pro max");
	invoice.getCostTextField().sendKeys("5000");
	invoice.getQuantity().sendKeys("1");
